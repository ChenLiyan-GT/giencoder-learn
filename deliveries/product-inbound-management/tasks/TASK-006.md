...
| 类型 | 文件路径 |
| --- | --- |
| 产品代码 | `src/main/java/com/example/demo/entity/TransferOrder.java` |
| 产品代码 | `src/main/java/com/example/demo/dto/TransferOrderDTO.java` |
| 产品代码 | `src/main/java/com/example/demo/repository/TransferOrderRepository.java` |
| 产品代码 | `src/main/java/com/example/demo/service/TransferOrderService.java` |
| 产品代码 | `src/main/java/com/example/demo/controller/TransferOrderController.java` |
| 测试代码 | `src/test/java/com/example/demo/controller/TransferOrderControllerTest.java` |
