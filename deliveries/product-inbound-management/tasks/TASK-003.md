...
| 类型 | 文件路径 |
| --- | --- |
| 产品代码 | `src/main/java/com/example/demo/entity/InboundOrder.java` |
| 产品代码 | `src/main/java/com/example/demo/dto/InboundOrderDTO.java` |
| 产品代码 | `src/main/java/com/example/demo/repository/InboundOrderRepository.java` |
| 产品代码 | `src/main/java/com/example/demo/service/InboundOrderService.java` |
| 产品代码 | `src/main/java/com/example/demo/controller/InboundOrderController.java` |
| 测试代码 | `src/test/java/com/example/demo/controller/InboundOrderControllerTest.java` |
