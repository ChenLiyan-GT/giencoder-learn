...
| TASK-003 | 入库机能 | TASK-001, TASK-002 | 🟡 Step 1-4 完成 | FUNC-001~004, FIELD-005, RULE-001~005, FLOW-001, INT-001 |
| TASK-004 | 出库机能 | TASK-001, TASK-002 | 🟡 Step 1-4 完成 | FUNC-009~012, FIELD-007, RULE-011~015, FLOW-003, INT-002 |
...
1. ✅ TASK-001 (已完成) → 2. ✅ TASK-002 (已完成) → 3. 🟡 TASK-003 (Step 1-4) → 4. 🟡 TASK-004 (Step 1-4) → 5. TASK-005 → 6. TASK-006 → 7. TASK-007
