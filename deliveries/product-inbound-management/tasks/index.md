...
| TASK-003 | 入库机能 | TASK-001, TASK-002 | ✅ 已完成 | FUNC-001~004, FIELD-005, RULE-001~005, FLOW-001, INT-001 |
| TASK-004 | 出库机能 | TASK-001, TASK-002 | ✅ 已完成 | FUNC-009~012, FIELD-007, RULE-011~015, FLOW-003, INT-002 |
| TASK-005 | 拣货机能 | TASK-001, TASK-002, TASK-004 | ✅ 已完成 | FUNC-005~008, FIELD-006, RULE-006~010, FLOW-002, INT-003 |
| TASK-006 | 仓库调拨机能 | TASK-001, TASK-002 | ✅ 已完成 | FUNC-017~022, FIELD-010, RULE-021~026, FLOW-004, INT-006, INT-007 |
| TASK-007 | 跨模块集成流程 | TASK-001~006 | ✅ 已完成 | INT-004, INT-005, FLOW-001~004 |
...
### 测试代码
- 测试代码放在 `src/test/java/com/gc/{機能名}/controller/` 下
- 例如：
