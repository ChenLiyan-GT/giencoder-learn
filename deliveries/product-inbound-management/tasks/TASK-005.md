...
TASK-004（OutboundOrder）✅ 待实现

## 文件计划

| 类型 | 文件路径 |
| --- | --- |
| 产品代码 | `src/main/java/com/common/entity/PickingOrder.java` |
| 产品代码 | `src/main/java/com/gc/picking/dto/PickingOrderDTO.java` |
| 产品代码 | `src/main/java/com/gc/picking/repository/PickingOrderRepository.java` |
| 产品代码 | `src/main/java/com/gc/picking/service/PickingOrderService.java` |
| 产品代码 | `src/main/java/com/gc/picking/controller/PickingOrderController.java` |
| 测试代码 | `src/test/java/com/gc/picking/controller/PickingOrderControllerTest.java` |
